...
/**
 * Unit Tests for {@link AggregateRepositoryOkHttpImpl}
 *
 * @author Fernando Boucquez
 */
public class AggregateRepositoryOkHttpImplTest extends AbstractOkHttpRespositoryTest {

    private AggregateRepositoryOkHttpImpl repository;


    @BeforeEach
    public void setUp() {
        super.setUp();
        repository = new AggregateRepositoryOkHttpImpl(apiClientMock);
    }
    ...
    @Override
    public AggregateRepositoryOkHttpImpl getRepository() {
        return repository;
    }
