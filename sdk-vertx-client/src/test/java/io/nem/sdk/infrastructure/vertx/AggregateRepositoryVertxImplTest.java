 ...
 */
public class AggregateRepositoryVertxImplTest extends AbstractVertxRespositoryTest {

    private AggregateRepositoryVertxImpl repository;


    @BeforeEach
    public void setUp() {
        super.setUp();
        repository = new AggregateRepositoryVertxImpl(apiClientMock, networkType);
    }
